...
def fetch_from_csv(csv_file_path:str, group_id:str)->list:
...
def get_file_properties(model_selected:str, input_type:str):
...
def remove_empty_rows(csv_file:str)->None:
...
def is_valid_csv(file_content)->bool:
    try:
...
def get_first_column_data(file_content)-> list[str]|None:
